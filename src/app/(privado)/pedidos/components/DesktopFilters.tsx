...
export default function DesktopFilters({
  ...
  return (
    <div className="hidden md:flex items-center gap-3">
      ...
      <button
        onClick={onApply}
        className="ml-auto px-5 py-2.5 text-sm font-medium text-white rounded-xl bg-gradient-to-r from-purple-500 to-violet-600 hover:from-purple-600 hover:to-violet-700 transition-all shadow-sm hover:shadow-md disabled:opacity-50"
        disabled={loading}
      >
        {loading ? (
