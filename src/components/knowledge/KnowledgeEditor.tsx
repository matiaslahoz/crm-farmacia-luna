...
export default function KnowledgeEditor() {
  ...
  async function handleSave() {
    ...
    if (res.ok) {
      ...
      alert("No se pudo guardar en Drive. Revisá consola/servidor.");
    }
  }
      ...
      <div className="p-3">
        {loading ? (
          ...
          <textarea
            ...
            className="w-full h-[60dvh] resize-vertical rounded-xl border border-gray-200 p-3 text-sm outline-none focus:border-gray-900"
          />
        )}
      </div>
    </div>
